...
if __name__ == '__main__':
    ...
    im = Image.open('image/esa.png')
    #im = im.rotate(90)
    
    
    #im = image.imread('image/esa.png')
    ...
    ax2.legend([is2_full[0],cs2_full[0]], ["", ""],
               handler_map={ is2_full[0]: HandlerLineImage('image/icesat21.png'), cs2_full[0]: HandlerLineImage('image/cryosat21.png')}, 
